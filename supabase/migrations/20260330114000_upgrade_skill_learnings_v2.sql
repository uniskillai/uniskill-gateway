-- Migration: Upgrade skill_learnings to Dual-Vector schema (V2)
...
ALTER TABLE skill_learnings 
  ...
  ADD COLUMN IF NOT EXISTS error_embedding vector(1536);

-- 2. Drop the old RPC
DROP FUNCTION IF EXISTS match_skill_learnings;
